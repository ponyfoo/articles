...
</code></pre> <p>You should look at the <a href="https://github.com/chriscoyier/Simple-Offline-Site" target="_blank" rel="noopener noreferrer" aria-label="chriscoyier/Simple-Offline-Site on GitHub">full code on the GitHub repository</a>!</p></div>
