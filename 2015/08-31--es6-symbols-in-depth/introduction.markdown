...
Thanks for listening to that, and let's go into symbols now! For a bit of context, you may want to check out the last two articles, -- on [iterators][6] and [generators][7] -- where we first talked about Symbols.
