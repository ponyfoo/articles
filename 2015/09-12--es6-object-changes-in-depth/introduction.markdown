...
Thanks for reading that, and let's go into changes to `Object`. Make sure to read some of the articles from [earlier in the series][5] to get comfortable with ES6 syntax changes.
