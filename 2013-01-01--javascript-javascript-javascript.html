<div><blockquote>
  ...
  <div><p>In my <a href="http://localhost:3000/2012/12/29/single-page-design-madness">previous installment</a>, I <em>prognosticated</em> the discussion topic for this post.</p><blockquote> <p>In the next post I&#x2019;ll delve into <strong>MongoDB</strong>, how to pair it with <strong>Node</strong>, and figuring &#x2026;</p></blockquote></div>
</blockquote></div>

<div><p>In my <a href="http://localhost:3000/2012/12/29/single-page-design-madness">previous installment</a>, I <em>prognosticated</em> the discussion topic for this post.</p></div>
