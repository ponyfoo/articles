<div><blockquote>
  ...
  <div><p>I&#x2019;ve briefly mentioned a few ES6 features <em>(and how to <a href="http://localhost:3000/articles/universal-react-babel#setting-up-babel">get started with Babel</a>)</em> in the React article series I&#x2019;ve been writing about, and now I want to <strong>focus &#x2026;</strong></p></div>
</blockquote></div>

<div><p>I&#x2019;ve briefly mentioned a few ES6 features <em>(and how to <a href="http://localhost:3000/articles/universal-react-babel#setting-up-babel">get started with Babel</a>)</em> in the React article series I&#x2019;ve been writing about, and now I want to <strong>focus on the language features</strong> themselves. I&#x2019;ve read a <em>ton</em> about ES6 and ES7 and it&#x2019;s about time we started discussing ES6 and ES7 features here in Pony Foo.</p></div>
