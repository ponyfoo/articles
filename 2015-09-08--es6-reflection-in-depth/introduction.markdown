...
Thanks for reading that, and let's go into `Reflect`. I suggest you read the articles on proxies: [`Proxy` built-in][6], [traps][7], and [more traps][8]. These will help you wrap your head around some of the content we'll go over today.
...
[6]: /articles/es6-proxies-in-depth
[7]: /articles/es6-proxy-traps-in-depth
[8]: /articles/more-es6-proxy-traps-in-depth
