...
Isolate scopes? What is this madness? The [second part of this article][61] is dedicated to directives, and it covers **isolate scopes, transclusion, linking functions, compilers, directive controllers, and more**.
