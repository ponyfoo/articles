<sub>&#x1F6A8; <strong>Autogenerated!</strong> See <a href="https://github.com/ponyfoo/articles/tree/noindex/contributing.markdown"><code>contributing.markdown</code></a> for details. See also: <a href="https://ponyfoo.com/articles/shared-rendering-with-rendr">web version</a>.</sub>
...
<div><figure><a href="https://github.com/rendrjs/rendr" target="_blank"><img src="https://i.imgur.com/88hPdca.png" alt="rendr.png"></a><figcaption>rendr.png</figcaption></figure> <p>Let&#x2019;s take a quick dive into the world of <a href="https://github.com/rendrjs/rendr" target="_blank">Rendr</a>.</p></div>
