...
A follow-up to this article can be found here: [Getting Over jQuery](http://blog.ponyfoo.com/2013/07/09/getting-over-jquery "Getting Over jQuery on Pony Foo")
