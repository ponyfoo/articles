...
</code></pre> <p>In this tutorial, we&#x2019;ll avoid using the CLI and learn how to set up our development environment from scratch. Meanwhile if you are interested in using the CLI with <a href="http://cloudinary.com/?utm_source=ponyfoo&amp;utm_medium=Sponsored_post_1&amp;utm_content=Angular2" target="_blank">Cloudinary</a>, check out this <a href="https://github.com/cloudinary/cloudinary_angular/tree/angular_next/samples/angular-cli-sample" target="_blank">great sample</a>. Should we use SystemJS? Is Webpack the best option? How does the transpiling work? You&#x2019;ll get the answers to these questions as we get our hands dirty with the nitty-gritty of setting up an Angular 2 application.</p></div>
